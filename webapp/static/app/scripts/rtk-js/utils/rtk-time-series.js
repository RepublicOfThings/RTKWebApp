...
function RTKTimeSeries(container, data){
    ...
    this.appendLine = function(name, xData, yData){
    ...
    this.render = function(){
        ...
        for (var i = 0; i < this.data.length; i++){
            ...
            logData.push(parseFloat(this.data[i].readings[1].value));
        }

		for (var i = 0; i < this.data.length; i++){
            // console.log(this.data[i].meta.r_squared);
            smoothData.push(parseFloat(this.data[i].meta.r_squared));
        }
